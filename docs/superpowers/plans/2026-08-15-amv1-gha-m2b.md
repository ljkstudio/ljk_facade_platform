...
- [ ] **Step 1: `saddle` 곡면 생성기를 파이썬에 넣는다**
...
- [ ] **Step 3: 재생성하고 `ray-` 가 실제로 켜지는지 본다 — 이 태스크의 판정**
...
- [ ] **Step 4: 안 켜지면 진폭을 키워 한 번 더 — 그래도 안 되면 정직하게 낮춘다**
...
- [ ] **Step 5: C# `TestSurfaceBuilder` 에 같은 분기를 넣는다**
...
- [ ] **Step 6: 지문 테스트로 C# 이 같은 안장면을 만드는지 확인한다**
